<?php
// This function display a specific Client in order to update it
require('navView.php');
    ...
    <div class="container">
      <fieldset>
        <legend>Modifier le client</legend>
          <div class="form">
            <form action="updateClientControl.php" method="post"> <?php // A FAIRE ?>
